...
const getSolFarmPoolInfo = async (
  ...
  try {
    ...
    // console.log("owner:"+decoded.owner.toString()),
    // console.log("borrowedValue:"+decoded.borrowedValue.toString()), // decimal
    // console.log("vaultShares:"+decoded.vaultShares.toString()), // decimal
    // //console.log("lpTokens:"+decoded.lpTokens.toString()), // decimal
    // console.log("coinDeposits:"+decoded.coinDeposits.toString()), // decimal
    // console.log("pcDeposits:"+decoded.pcDeposits.toString()), // decimal
    // //console.log("depositsMarketValue:"+decoded.depositsMarketValue.toString()), // decimal
    // console.log("lpDecimals:"+decoded.lpDecimals.toString()),
    // console.log("coinDecimals:"+decoded.coinDecimals.toString()),
    // console.log("pcDecimals:"+decoded.pcDecimals.toString()),
    // //console.log("depositsLen:"+decoded.depositsLen.toString()),
    // console.log("borrowsLen:"+decoded.borrowsLen.toString()),
    // console.log("------------------------------------------");
    ...
    if (_poolVault == 0) {
      ...
      //console.log(baseTokenTotal.toNumber());

...
const getReservePoolData = async (
  ...
  try {
    ...
    let mintAddress = findReserveTokenByAccount(_reserveAccount).mintAddress;
    ...
    return {
      ...
      userTokenToUSDBalance: ATABalance * _tokenPrice,
...
const findReserveTokenByAccount = (_account) => {
  try {
    ...
    //   account: _account
    // });
    const reserve = LENDING_RESERVES.find(e=>e.account == _account)
